...
export class PagoService {
  private apiUrl = 'https://terra-canada-test-back.vamw1k.easypanel.host/api/v1/pagos';
  ...
  scanPagoDocumento(
    ...
    return this.http.post<PagoScanResponse>(url, payload);
  }
  ...
  enviarDocumentosRecibiendoPdf(
    ...
    return this.http.post<PagoScanResponse>(url, payload, { headers });
  }
