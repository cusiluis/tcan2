...
export class FinancierosTarjetasComponent implements OnInit {
  ...
  openEditModal(pago: any): void {
    ...
    this.scanError = null;
    this.isScanSuccess = pago.estado === 'PAGADO' && !!pago.esta_verificado;
    ...
    // Si el pago ya está pagado y verificado (ya fue escaneado previamente),
    // permitimos que el administrador edite estos campos.
  ...
  onSubmitEdit(): void {
    ...
    const updateData = {
      estado: nuevoEstado,
      esta_verificado: nuevaVerificacion,
